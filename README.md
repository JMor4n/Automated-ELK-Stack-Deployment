...
|------------------------|--------|-----------------|--------|-----------------------------------------|
| * 110.175.97.198       |        | HTTPS           | SSH    | Encripted connection using a Public Key |

* This IP adress is dinamic and change every day when the Router is rebooted.
...
| Name          |IP Adress             | Publickly Accessible | Allowed IP Addresses | Access Method                      |
|---------------|----------------------|----------------------|----------------------|------------------------------------|
...
- The installation can be copied to any machine. This methos proves to be perfect to scale fast if it required and allow less missconfiguration.
